/**
 * @file Main types file with short aliases
 *
 *   All types are available through short names without long paths. Instead of
 *   `import("#@types/fastify/instance.jsdoc.js").FastifyInstanceExtended` you can use simply `FastifyInstance`.
 * @example
 *   ```javascript
...
/**
 * Extended FastifyRequest with pagination property Automatically includes pagination in all route handlers when
 * paginationPlugin is registered
 *
