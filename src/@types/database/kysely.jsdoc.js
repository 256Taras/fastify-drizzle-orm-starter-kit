 ...
 *
 * Uses official Drizzle Team solution: Kyselify type from drizzle-orm/kysely
 * This automatically converts Drizzle types to Kysely types - no manual typing needed!
 *
 ...
 *
 * Kyselify automatically converts Drizzle table types to Kysely-compatible types.
 * Table names in Kysely match database table names (snake_case for auth_tokens).
 *
 ...
 * Note: Using PostgresJsDatabase from drizzle-orm which is compatible with Kysely types
