/**
 * @file Extended FastifyInstance with all custom methods and properties
 *
 *   This is the final type that combines all Fastify extensions.
 */

/**
 * Get pagination query from request This helper ensures proper type inference for req.pagination Works for both offset and
