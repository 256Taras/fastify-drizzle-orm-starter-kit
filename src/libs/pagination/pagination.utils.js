 ...
 *
 * @template TItem - The type of the items in the collection.
 ...
 * @returns {import("./pagination.types.jsdoc.js").OffsetPaginatedResponse<TItem>} A DTO representing the paginated
 *   collection.
 */
 ...
 *
 * @template TItem - The entity type included in the paginated response.
